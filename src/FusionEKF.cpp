...
FusionEKF::FusionEKF() {
  ...
  */
  ...
  // picking the laser matrix just as a placeholder
	MatrixXd R_in = R_laser_;

	//measurement matrix
  // picking the laser matrix just as a placeholder, never used by the algorithm
  H_laser_ << 1, 0, 0, 0,
              0, 1, 0, 0;
  ...
  // set the initial process noise covariance
